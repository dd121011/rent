    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            ...
                            '<div class="admin-header-lock-name" id="lockUserName">kse-music</div>'+
                            '<div class="input_btn">'+
        ...
        layer.open({
            ...
            content : '<div class="skins_box">'+
                            '<form class="layui-form">'+
                                ...
                                '</div>'+
                                '<div class="layui-form-item skinBtn">'+
                                    '<a href="javascript:;" class="layui-btn layui-btn-sm layui-btn-normal" lay-submit="" lay-filter="changeSkin">更换</a>'+

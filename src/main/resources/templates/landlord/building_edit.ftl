<div id="addDiv" style="padding: 20px 0; padding-right: 40px; display: none" >
    <form class="layui-form" lay-filter="building" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <#list facilityList as item>
                    <input type="checkbox" name="dicItermIds" value="${item.dicItermId}" title="${item.value}">
                </#list>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <#list extraList as item>
                    <input type="checkbox" name="extraIds" value="${item.extraId}" title="${item.name}">
                </#list>
            </div>
        </div>
        <div class="layui-form-item">

...
<body class="childrenBody">
	...
	<#--<blockquote class="layui-elem-quote main_btn">
		...
		<p class="layui-blue">注：本模版未引入任何第三方组件，单纯的layui+js实现的各种功能。网站所有数据均为静态数据，无数据库，除打开的窗口和部分小改动外所有操作刷新后无效，关闭窗口或清除缓存后，所有操作无效，请知悉。</p>
	</blockquote>-->
			...
			<div class="layui-elem-quote layui-quote-nm history_box magb0">
				<ul class="layui-timeline">
					...
					<li class="layui-timeline-item">
						...
						<div class="layui-timeline-content layui-text">
							<div class="layui-timeline-title">
								<h3 class="layui-inline">Bug修复 发布MCN 2.7.0　</h3>
								<span class="layui-badge-rim">2017-07-05</span>
							</div>
							<ul>
								<li># v2.7.1 - 2018-08-25</li>

		...
		<form class="layui-form">
			<div class="layui-inline">
				<div class="layui-input-inline">
					<input type="text" class="layui-input searchVal" placeholder="请输入关键词" />
				</div>
				<div class="layui-input-inline news-status">
                    <select name="status">
...
<script type="text/javascript" src="${base}/static/js/page/news/newsList.js"></script>
</body>
</html>